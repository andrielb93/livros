...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { Autor: @livro.Autor, Descricao: @livro.Descricao, Nota: @livro.Nota, Título: @livro.Título } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { Autor: @livro.Autor, Descricao: @livro.Descricao, Nota: @livro.Nota, Título: @livro.Título } }
